...
class BigQueryEngineAdapter(EngineAdapter):
    ...
    def create_schema(
        self, schema_name: str, catalog_name: t.Optional[str] = None, ignore_if_exists: bool = True
    ) -> None:
        ...
        try:
            super().create_schema(
                schema_name, catalog_name=catalog_name, ignore_if_exists=ignore_if_exists
            )
